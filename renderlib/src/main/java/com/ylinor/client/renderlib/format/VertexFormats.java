...
public class VertexFormats {
    ...
    public static final VertexFormatElement COLOR_3F = new VertexFormatElement(PrimitiveType.FLOAT, Usage.COLOR, 3);
    ...
    public static final VertexFormat BLOCKS = new VertexFormat(POS_3F, COLOR_4F, NORMAL_3F, TEXCOORDS_2F);
}