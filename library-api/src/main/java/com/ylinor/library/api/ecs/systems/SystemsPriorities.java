...
public class SystemsPriorities {
    ...
    public static final class Render {
        ...
        public static final int CLEAR_SCREEN = RENDER_PRIORITY;
        public static final int TERRAIN_RENDER = -100 + RENDER_PRIORITY;
        public static final int HUD_RENDER = -200 + RENDER_PRIORITY;
        public static final int SCREEN_RENDER = -300 + RENDER_PRIORITY;
    }
