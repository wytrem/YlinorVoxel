...
public class Material {
    ...
    public static final Material ANVIL = (new Material(MapColor.IRON)).setRequiresTool()
    ...
    public static final Material REDSTONE_LIGHT = (new Material(MapColor.AIR));
    public static final Material TNT = (new Material(MapColor.TNT)).setBurning()
                                                                   .setTranslucent();
    ...
    public static final Material PACKED_ICE = (new Material(MapColor.ICE));
    ...
    public static final Material CACTUS = (new Material(MapColor.FOLIAGE)).setTranslucent()
                                                                          .setNoPushMobility();
