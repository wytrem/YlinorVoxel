...
public final class YlinorLauncher {
    ...
    //private static Saver saver = new Saver(new File(LAUNCHER_FOLDER, "launcher.properties"));
    private static CrashReporter reporter = new CrashReporter(TITLE, new File(LAUNCHER_FOLDER, "crashes/"));
